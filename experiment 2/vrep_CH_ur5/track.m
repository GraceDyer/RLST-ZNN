...
jointValue=load('adata.txt'); %A matrix of 6 x 125.Each column vector recorded the changes of each joint Angle 
[m n]=size(jointValue);
...
[res,handle_rightArmjoint1] = vrep.simxGetObjectHandle(clientID,'UR5_joint1',vrep.simx_opmode_oneshot_wait); 
[res,handle_rightArmjoint2] = vrep.simxGetObjectHandle(clientID,'UR5_joint2',vrep.simx_opmode_oneshot_wait); 
[res,handle_rightArmjoint3] = vrep.simxGetObjectHandle(clientID,'UR5_joint3',vrep.simx_opmode_oneshot_wait); 
[res,handle_rightArmjoint4] = vrep.simxGetObjectHandle(clientID,'UR5_joint4',vrep.simx_opmode_oneshot_wait); 
[res,handle_rightArmjoint5] = vrep.simxGetObjectHandle(clientID,'UR5_joint5',vrep.simx_opmode_oneshot_wait); 
[res,handle_rightArmjoint6] = vrep.simxGetObjectHandle(clientID,'UR5_joint6',vrep.simx_opmode_oneshot_wait); 
...
pause(0.01);
   ...
   vrep.simxGetConnectionId(clientID)=0;
end
